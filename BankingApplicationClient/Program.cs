...
namespace BankingApplication_Complete
{
    class Program
    {
        ...
        private static bool ReadAndInsertCustomerData()
        {
            ...
            //string filePath = "D:\\HandsOn\\BankingApplication\\BankingApplicationClient\\customerDetails.csv";
            ...
            {
                throw new Exception("Exception occured while trying to Add Customer Bank Record");
            }
        ...
        private static CustomerRecord ValidateInputData(string recordData)
        {
            ...
            customerRecord.AccountOpeningDate = DateTime.ParseExact(values[7], "MM/dd/yyyy", CultureInfo.InvariantCulture);
